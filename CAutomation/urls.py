...
from cleaning.views import PointListView, PointUpdateView, WorkerListView, WorkerUpdateView, TruckListView, TruckUpdateView
...
urlpatterns = [
    ...
    path('points/<int:pk>', PointUpdateView.as_view()),
